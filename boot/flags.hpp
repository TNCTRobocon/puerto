...
public:
    FlagString(std::string& _value, const std::string& _usage) : FlagBase(_usage), value(_value) {}
...
public:
    FlagInt(int& _value, const std::string& _usage) : FlagBase(_usage), value(_value) {}
    virtual void Set(const std::string& inst) {
        value = std::stoi(inst);
    }
};
...
public:
    FlagBool(bool& _value, const std::string& _usage) : FlagBase(_usage), value(_value) {}
    virtual void Set(const std::string& inst);
    void Set(bool x) {
        value = x;
    }
...
public:
    ...
    virtual ~Flags();
    // Add
    void Add(const std::string& key, std::string& value, const std::string& usage) {
    ...
    void Add(const std::string& key, int& value, const std::string& usage) {
        flags.emplace(key, new FlagInt(value, usage));
    }
    // Parse
